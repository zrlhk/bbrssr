...
```sh
wget --no-check-certificate https://github.com/zrlhk/bbrssr/blob/master/kcptun/kcptun.sh
sh kcptun.sh
```
...
```sh
wget --no-check-certificate https://github.com/zrlhk/bbrssr/edit/master/ovz-bbr/ovz-bbr-installer.sh
